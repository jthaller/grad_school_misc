...
# I've set this up to run as interactive code is VS Code 
...
# grain_1_ln = df_nline.drop(df.columns[0:2], axis=1)
# #create new row = mean
# grain_1_ln.loc['mean'] = grain_1_ln.mean()
# #get rid of everything other than oxide weights
# grain_1_ln = grain_1_ln.loc['mean'][0:14].values
# #normalize so percentages add up to 100% total
# grain_1_ln = [grain/grain_1_ln[-1] *100 for grain in grain_1_ln]
grain_1_ln = mean_and_normalize(df_nline)
print(grain_1_ln)

#%% # GRAIN 1 DAYTIME POINTS
